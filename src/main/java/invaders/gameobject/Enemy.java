...
public class Enemy implements GameObject, Renderable {
    ...
    @Override
    public void update(GameImportant engine) {

//        System.out.println(enemyProjectile);
//        for (Projectile item:enemyProjectile) {
//            System.out.println(item.getRenderableObjectName());
//        }
//        System.out.println(enemyProjectile.size());
...
//            逐渐下降
    ...
    public void takeDamage(double amount) {
        System.out.println("生命建议");
        this.lives-=1;
        this.sorce +=1;
        System.out.println(this.lives);
        System.out.println(this.sorce);
    }
